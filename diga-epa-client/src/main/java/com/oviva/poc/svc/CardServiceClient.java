...
package com.oviva.poc.svc;

import com.oviva.poc.konn.util.KonnektorUtils;
...
public class CardServiceClient {
  ...
  private static Logger log = LoggerFactory.getLogger(CardServiceClient.class);
  ...
  private VerifyPin buildVerifyPin(String cardHandle, String pinType) {
    ...
    verifyPinRequest.setContext(konnektorContext.toContext());
