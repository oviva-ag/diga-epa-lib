 ...
 * }</pre>
 *
 * in the class {@link de.gematik.epa.ps.konnektor.impl.xml.ObjectFactory} and make this
 * ObjectFactory known to the Jaxb context (depending on the implementation, the function {@link
 * de.gematik.epa.ps.konnektor.impl.xml.ObjectFactory#registerObjectFactory(org.apache.cxf.frontend.ClientProxyFactoryBean)}
