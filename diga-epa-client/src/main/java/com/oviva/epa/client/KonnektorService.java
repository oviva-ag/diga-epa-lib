...
public interface KonnektorService {
  ...
  @NonNull
  X509Certificate readRsaAuthenticationCertificateForCard(@NonNull String cardHandle);

  @NonNull
  X509Certificate readEccAuthenticationCertificateForCard(@NonNull String cardHandle);
